...
export default function App() {
  ...
  return (
    <SafeAreaView style={styles.screen}>
      <Text style={styles.badge}>Chapter 05</Text>
      <Text style={styles.title}>프로필 직접 추가하기</Text>
      <Text style={styles.subtitle}>
        입력한 이름을 새 카드로 목록 맨 앞에 추가합니다.
      </Text>
      ...
      <View style={styles.inputRow}>
        <TextInput
          ...
          placeholder="추가할 프로필 이름"
          placeholderTextColor="#94a3b8"
        />
        <Pressable style={styles.addButton} onPress={addProfile}>
