...
EXAMPLE_ASSETS_DIR = CHAPTER_DIR / "examples" / "expo-sort-list" / "assets"
AVATAR_PATH = EXAMPLE_ASSETS_DIR / "profile-card-avatar.png"
SCREENSHOT_PATH = ARTIFACTS_DIR / "ch7_sort_list.jpg"
...
def main() -> None:
    ...
    draw.text((68, 82), "Chapter 07", font=badge_font, fill="#2563eb")
    draw.text((68, 132), "프로필 정렬하기", font=title_font, fill="#0f172a")
    draw.text((68, 214), "정렬 기준에 따라 같은 목록도 다른 순서로 보여 줄 수 있습니다.", font=subtitle_font, fill="#475569")
    ...
    cards = [
        ...
        ("컴포넌트 연구원", "Search UI Builder", "새 글 알림을 받고 있는 프로필입니다.", "#0f766e", "팔로잉"),
